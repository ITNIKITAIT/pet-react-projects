...
const Field = () => {
    ...
    return (
        <div className="max-w-[800px] mx-auto">
            <div
                ref={fieldRef}
                className="border-4 border-violet-400 rounded-md text-[26px] py-3 px-5 mb-5 leading-[50px] h-[130px] overflow-hidden w-full">
                {words.map((word, i) => (
                    <div
            ...
            <div className="flex gap-5 items-center">
                ...
                <button className="bg-violet-500 rounded-lg p-1">
            ...
            <div className="w-full h-5 rounded-2xl bg-transparent mt-5 border-[1px] border-slate-400 overflow-hidden">
                <div className="bg-gradient-to-r from-violet-400 to-violet-600 w-[90%] h-full"></div>
            </div>
        </div>
    );
};
