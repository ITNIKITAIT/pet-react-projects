...
const Field = () => {
    ...
    return (
        <div className="max-w-[800px] mx-auto">
            <div
                ref={fieldRef}
                className="border-4 border-violet-400 rounded-md text-[26px] py-3 px-5 mb-5 leading-[58px] h-[150px] overflow-hidden w-full">
                <div className="field--wrapper">
                    {words.map((word, i) => (
                        <div
                            className={`inline-block px-2 ${
                                i === printedWords.length ? 'word-current' : ''
                            }
                        ${
                            printedWords[i] &&
            ...
            <div className="flex gap-5 items-center">
                ...
                />
                <div className="text-[18px] text-violet-500 bg-[#E5E7EB] py-2 px-3 rounded-lg font-medium">
                    0:{time}
                </div>
                <button
                    onClick={reload}
